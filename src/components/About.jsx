  ...
  return (
    ...
    <section className="section about">
                ...
                <div className="about-info">
                    ...
                    <p className="desc">
                    Hi, I’m Satish Kumar Meher, a passionate full-stack web developer and second-year B.Tech student at the International Institute of Information Technology, Bhubaneswar. I hail from Bargarh, Odisha, and have a strong foundation in programming with over two years of experience.<br/>
